...
//       <h1 className="text-3xl font-bold mb-8 text-center">✨ All Influencers</h1>
...
//               <Card
//                 className="group bg-white/80 backdrop-blur-md border border-gray-100 hover:shadow-xl transition-transform transform hover:-translate-y-1 rounded-2xl overflow-hidden"
//               >
...
//                       alt={inf.userId?.name}
//                       className="w-24 h-24 rounded-full object-cover border-4 border-white shadow-lg mb-3 transition-transform group-hover:scale-105"
//                     />
//                     {inf.verified && (
//                       <Badge
//                         variant="secondary"
//                         className="absolute -bottom-2 right-2 bg-blue-600 text-white text-xs flex items-center gap-1"
//                       >
...
//                     <span>▶️ {inf.followers?.youtube || 0}</span>
